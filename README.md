...
4. Preview the hitbox in real time and adjust timing/knockback as needed
5. Click **Export** to generate the Lua module for your move
...
> If you want to send Robux, you'll need a Roblox Plus Subscription.
